...
public final class Localization {
    ...
    static {
        ...
        EN.put("helplist.menu-title", "&7[&a&lHelpMe&7] &7Pending Requests");
        EN.put("helplist.menu-request-label", "&7Request:");
        EN.put("helplist.menu-left-click", "&aLeft-click to Accept");
        EN.put("helplist.menu-right-click", "&cRight-click to Reject");
        ...
        FA.put("helplist.menu-title", "&7[&a&lHelpMe&7] &7درخواست‌های در انتظار");
        FA.put("helplist.menu-request-label", "&7درخواست:");
        FA.put("helplist.menu-left-click", "&aکلیک چپ برای پذیرش");
        FA.put("helplist.menu-right-click", "&cکلیک راست برای رد");
        ...
        FA.put("helpadmins.header", "&7آمار هلپرا:");
